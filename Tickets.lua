    ...
    if (GMGenie.Tickets.currentTicket["ticketId"] and GMGenie.Tickets.currentTicket["ticketId"] == ticketId) then
        ...
        if GMGenie.Tickets.idToNum[ticketId] then
            if GMGenie.Tickets.list[GMGenie.Tickets.idToNum[ticketId]]["name"] then
                ...
                GMGenie_Tickets_View_Title_Text:SetText(GMGenie.Tickets.currentTicket["name"] .. "'s Ticket (ID: ".. ticketId ..")");
...
-- mati
function GMGenie.Tickets.Response()
    GMGenie_Tickets_ResponsePopup:Show();
    GMGenie_Tickets_ResponsePopup_ResponseText:SetText("");
    GMGenie_Tickets_ResponsePopup_ResponseText:SetHeight(130);
    GMGenie_Tickets_ResponsePopup_ResponseText:SetWidth(200);
    GMGenie_Tickets_ResponsePopup_ResponseText:SetMaxLetters(200);
    GMGenie_Tickets_ResponsePopup_ResponseText:SetMultiLine(true);
...
function GMGenie.Tickets.ResponseSet()
   SendChatMessage(".tic res app ".. GMGenie.Tickets.currentTicket["ticketId"].." "..GMGenie_Tickets_ResponsePopup_ResponseText:GetText(), "GUILD");
   GMGenie.Tickets.done = GMGenie.Tickets.done + 1;
   GMGenie_SavedVars.ticketsDone = GMGenie.Tickets.done;
   local offlineCount = GMGenie.Tickets.tickets - GMGenie.Tickets.onlineTickets;
   GMGenie.Tickets.close();
